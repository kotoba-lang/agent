...
if (web.kotobaArtifact.requiredCapabilities.length !== 0) {
  throw new Error("bounded AgentRun Web artifact requested a capability");
}
if (web.instantiateKotoba().main() !== 42n) {
  throw new Error("bounded AgentRun Web self-check mismatch");
}
...
if (wasm.instance.exports.main() !== 42n) {
  throw new Error("bounded AgentRun Wasm self-check mismatch");
}

console.log("agent: bounded AgentRun Web/Wasm conformance passed");
